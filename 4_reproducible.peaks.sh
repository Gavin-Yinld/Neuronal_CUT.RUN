...
sort -k7,7nr $rep1 > $sorted_rep1
sort -k7,7nr $rep2 > $sorted_rep2
idr --samples $sorted_rep1 $sorted_rep2 --input-file-type narrowPeak --rank signal.value --output-file EGR1-exc_idr --plot --log-output-file EGR1-exc.idr.log
...
sort -k7,7nr $rep1 > $sorted_rep1
sort -k7,7nr $rep2 > $sorted_rep2
idr --samples $sorted_rep1 $sorted_rep2 --input-file-type narrowPeak --rank signal.value --output-file EGR1-inh_idr --plot --log-output-file EGR1-inh.idr.log
